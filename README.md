...
|`ldak`|[LDAK/SumHer](https://dougspeed.com/summary-statistics/)|LDAK/SumHer summary-statistics format (`Predictor`, `A1`, `A2`, `n`, `Z` or `BETA`/`SE`, optional `A1Freq`)|Speed D, Holmes J, Sumner MD, et al. (2020). Reevaluation of SNP heritability in complex human traits. Nature Genetics.|
